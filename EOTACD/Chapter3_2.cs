...
public class Chapter3_2 : screen
{
    Game1 game;
    Player player1;
    Player player2;
    ...
    int timer;
    public Chapter3_2(Game1 game, EventHandler theScreenEvent) : base(theScreenEvent)
    {
        this.game = game;
        ...
        cut1 = game.Content.Load<Texture2D>("Last1");
        cut2 = game.Content.Load<Texture2D>("Last2");

        bg = game.Content.Load<Texture2D>("Chapter302Example");
    ...
    public override void Update(GameTime gameTime)
    {
        ...
        if (player1.Position.X > 1600 || player2.Position.X > 1600 )
        {
            timer++;
        }
    ...
    public override void Draw(SpriteBatch theBatch, GameTime gameTime)
    {
        ...
        {
            theBatch.Draw(cut1,Vector2.Zero,Color.White);
        }
        if(timer >= 350 && timer <= 600)
        {
            theBatch.Draw(cut2, Vector2.Zero, Color.White);
        }
        if(timer >= 600)
        {
