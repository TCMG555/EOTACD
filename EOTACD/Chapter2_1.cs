...
public class Chapter2_1 : screen
{
    Game1 game;
    Player player1;
    Player player2;
    ...
    public Chapter2_1(Game1 game, EventHandler theScreenEvent) : base(theScreenEvent)
    {
        this.game = game;

     
        // Initialize player1 and player2 for Chapter1_1 with different starting positions
        player1 = new Player(new Vector2(120, 700), 200f, Keys.I, Keys.K, Keys.J, Keys.L, 765f, 1920, 1080);
        player2 = new Player(new Vector2(50, 700), 200f, Keys.W, Keys.S, Keys.A, Keys.D, 765f, 1920 , 1080);
    ...
    public override void Update(GameTime gameTime)
    {
       ...
       // CheckCollision(player2);
        ...
        if (player1.Position.X > 1600 || player2.Position.X > 1600 && Keyboard.GetState().IsKeyDown(Keys.Space))
        {
            ...
            ScreenEvent.Invoke(game.mGameplayCT2_2, new EventArgs());
            return;
        }
        // Update cameras
