...
public class Chapter3_1 : screen
{
    Game1 game;
    Player player1;
    Player player2;
    ...
    public Chapter3_1(Game1 game, EventHandler theScreenEvent) : base(theScreenEvent)
    {
        this.game = game;
      
        bg = game.Content.Load<Texture2D>("Chapter03_01Example");
        ...
        com2 = new Rectangle(800, 600, 500, 500);
        note = game.Content.Load<Texture2D>("NoteScreen-2");
        //bgLab = game.Content.Load<Texture2D>("Chapter2_01");
    ...
    public override void Update(GameTime gameTime)
    {
        ...
        if (player1.Position.X > 1600 || player2.Position.X > 1600 && Keyboard.GetState().IsKeyDown(Keys.Space))
        {
            ...
            ScreenEvent.Invoke(game.mGameplayCT3_2, new EventArgs());
            return;
        }
        /// Enemy
        ...
        if ((new Rectangle((int)player1.Position.X, (int)player1.Position.Y, 500, 500).Intersects(com2) ||
             new Rectangle((int)player2.Position.X, (int)player2.Position.Y, 500, 500).Intersects(com2)) &&
    ...
    public override void Draw(SpriteBatch theBatch, GameTime gameTime)
    {
        ...
        if (inter)
        {
            theBatch.Draw(note, new Rectangle(1920 / 2 - 450, 1080 / 2 - 450, 900, 900), Color.White);
        }
